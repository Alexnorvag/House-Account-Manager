...
namespace House_Accounting_Manager {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(decimal TotalIncome, decimal Remaining) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public decimal TotalIncome {
                get {
                    try {
                        return ((decimal)(this[this.tableTable.TotalIncomeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'TotalIncome\' в таблице \'Table\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.TotalIncomeColumn] = value;
                }
            }
            ...
            public decimal Remaining {
                get {
                    try {
                        return ((decimal)(this[this.tableTable.RemainingColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Remaining\' в таблице \'Table\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.RemainingColumn] = value;
                }
            }
            ...
            public bool IsTotalIncomeNull() {
                return this.IsNull(this.tableTable.TotalIncomeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetTotalIncomeNull() {
                this[this.tableTable.TotalIncomeColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public bool IsRemainingNull() {
                return this.IsNull(this.tableTable.RemainingColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetRemainingNull() {
                this[this.tableTable.RemainingColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace House_Accounting_Manager.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_TotalIncome = 1 AN" +
                "D [TotalIncome] IS NULL) OR ([TotalIncome] = @Original_TotalIncome)) AND ((@IsNu" +
                "ll_Remaining = 1 AND [Remaining] IS NULL) OR ([Remaining] = @Original_Remaining)" +
                "))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_TotalIncome", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 18, 0, "TotalIncome", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Table] ([TotalIncome], [Remaining]) VALUES (@TotalIncome, @Remaining" +
                ");\r\nSELECT Id, TotalIncome, Remaining FROM [Table] WHERE (Id = SCOPE_IDENTITY())" +
                "";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@TotalIncome", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 18, 0, "TotalIncome", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Table] SET [TotalIncome] = @TotalIncome, [Remaining] = @Remaining WHERE (([Id] = @Original_Id) AND ((@IsNull_TotalIncome = 1 AND [TotalIncome] IS NULL) OR ([TotalIncome] = @Original_TotalIncome)) AND ((@IsNull_Remaining = 1 AND [Remaining] IS NULL) OR ([Remaining] = @Original_Remaining)));
SELECT Id, TotalIncome, Remaining FROM [Table] WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@TotalIncome", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 18, 0, "TotalIncome", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_TotalIncome", global::System.Data.SqlDbType.Decimal, 0, global::System.Data.ParameterDirection.Input, 18, 0, "TotalIncome", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::House_Accounting_Manager.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, TotalIncome, Remaining FROM [Table]";
        ...
        public virtual int Delete(int Original_Id, global::System.Nullable<decimal> Original_TotalIncome, global::System.Nullable<decimal> Original_Remaining) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
            if ((Original_TotalIncome.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[2].Value = ((decimal)(Original_TotalIncome.Value));
            }
            else {
            ...
            if ((Original_Remaining.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((decimal)(Original_Remaining.Value));
            }
            else {
        ...
        public virtual int Insert(global::System.Nullable<decimal> TotalIncome, global::System.Nullable<decimal> Remaining) {
            if ((TotalIncome.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[0].Value = ((decimal)(TotalIncome.Value));
            }
            else {
                this.Adapter.InsertCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            if ((Remaining.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[1].Value = ((decimal)(Remaining.Value));
            }
            else {
        ...
        public virtual int Update(global::System.Nullable<decimal> TotalIncome, global::System.Nullable<decimal> Remaining, int Original_Id, global::System.Nullable<decimal> Original_TotalIncome, global::System.Nullable<decimal> Original_Remaining, int Id) {
            if ((TotalIncome.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((decimal)(TotalIncome.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            if ((Remaining.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[1].Value = ((decimal)(Remaining.Value));
            }
            else {
            ...
            if ((Original_TotalIncome.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((decimal)(Original_TotalIncome.Value));
            }
            else {
            ...
            if ((Original_Remaining.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((decimal)(Original_Remaining.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<decimal> TotalIncome, global::System.Nullable<decimal> Remaining, int Original_Id, global::System.Nullable<decimal> Original_TotalIncome, global::System.Nullable<decimal> Original_Remaining) {
            return this.Update(TotalIncome, Remaining, Original_Id, Original_TotalIncome, Original_Remaining, Original_Id);
        }
    }
